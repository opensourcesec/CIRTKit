...
from lib.common.utils import get_type
from lib.core.session import __sessions__

from modules.reversing.viper.pdftools.pdfid import PDFiD, PDFiD2JSON
from modules.reversing.viper.peepdf.PDFCore import PDFParser
